...
const CreateDonation = () => {
  ...
  return (
    <>
      ...
      <div className={`mt-25 lg:mt-10 flex flex-col items-center justify-center absolute inset-0 ${login?`hidden`:`block`}`}>
        ...
        <Link className="btn btn-primary p-5 text-xl" to="/login">Login</Link>
      </div>  
    </>
  );
};
